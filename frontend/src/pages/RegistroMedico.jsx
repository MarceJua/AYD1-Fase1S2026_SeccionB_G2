...
const RegistroMedico = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!cvPdf) {
      alert("El CV en formato PDF es obligatorio para médicos.");
      return;
    }
    ...
    data.append("cv_pdf", cvPdf);

    try {
      const res = await axios.post(
        "http://localhost:5000/api/auth/medico/registro",
        data,
      );
      ...
      <div className="auth-card" style={{ maxWidth: "600px" }}>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="form-grid">
            ...
            <div
              className="full-width auth-form"
              style={{ textAlign: "left", gap: "5px" }}
            >
              <label style={{ fontSize: "14px", color: "#64748b" }}>
            ...
            >
              ...
              <input
                ...
                name="cv_pdf"
                accept=".pdf"
                onChange={(e) => setCvPdf(e.target.files[0])}
                required
              />
            </div>
          </div>
