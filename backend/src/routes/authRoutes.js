...
// HU-208 y HU-209: Rutas de estadísticas del admin
router.get("/admin/denuncias", verifyAdminToken("admin"), obtenerDenuncias);
router.delete(
  "/admin/denuncias/:id",
...
router.get(
  "/admin/calificaciones-promedios",
  verifyAdminToken("admin"),
  obtenerPromediosCalificaciones,
);
router.get(
  "/admin/grafico-horarios",
  verifyAdminToken("admin"),
  obtenerGraficoHorarios,
);
router.get(
  "/admin/grafico-cancelaciones",
  verifyAdminToken("admin"),
  obtenerGraficoCancelaciones,
);
